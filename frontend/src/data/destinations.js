export const DESTINATIONS = [
  {
    ...
    facilities: ["Area Parkir Kendaraan", "Sewa Aksesori", "Toilet Bermutu", "F&B Cashless NFC", "Pos Kesehatan", "Gate Terminal QR"],
  ...
  },
  {
    ...
    facilities: ["Posko Utama", "Sewa Alat Keamanan", "Toilet Basecamp", "Posko Darurat", "Gate Scanner NFC"],
    ...
    ticket_categories: [
      { id: "cat-1", name: "Tiket Masuk Reguler (Hari Kerja)", price: 25000, insurance: 2500, retribusi: 2500 },
      { id: "cat-2", name: "Tiket Masuk Reguler (Akhir Pekan)", price: 35000, insurance: 2500, retribusi: 2500 },
      { id: "cat-3", name: "Tiket Wisatawan Internasional", price: 150000, insurance: 5000, retribusi: 10000 }
    ]
  },
  {
    id: "dest-tumpaksewu",
    name: "Kawasan Ekowisata Air Terjun & Lembah",
    slug: "ekowisata-air-terjun-gamma",
    type: "air_terjun",
    ...
    description: "Simulasi white-label Passify untuk wisata air terjun dan aktivitas penjelajahan alam. Mendukung pembayaran nirsentuh di merchant kawasan.",
    facilities: ["Viewpoint Panorama", "Jalur Tracking Aman", "Pemandu Lokal Resmi", "Toilet Bersih", "Tenant F&B Cashless"],
    rules: "Gunakan alas kaki anti selip saat menuruni lembah dan ikuti jalur resmi yang telah ditentukan.",
    time_slots: [
  ...
  },
  {
    ...
    description: "Sistem reservasi white-label untuk taman nasional kepulauan dan konservasi satwa dilindungi. Terintegrasi dengan gelang NFC untuk akses dermaga.",
  ...
  },
  {
    ...
    facilities: ["Spot Foto Panorama", "Area Glamping & Kemah", "Toilet Bermutu", "Kafe & Lounge Cashless", "Dermaga Ferry"],
