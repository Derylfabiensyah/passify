...
export const TENANT_INFO = {
  id: "tenant-001",
  name: "Pengelola Kawasan Konservasi Alpha • White-Label Tenant",
  logo_url: null,
  primary_color: "#059669",
  subscription_plan: "Enterprise White-Label SaaS",
...
export const TICKET_CATEGORY_SALES = [
  ...
  { name: "Kendaraan & Shuttle", sold: 1600, revenue: 16000000, percentage: 10 },
];
...
export const RECENT_TRANSACTIONS = [
  ...
  { id: "trx-006", code: "TWA-20260730-1239", visitor: "Dewi Lestari", category: "Kendaraan & Shuttle", qty: 1, amount: 10000, status: "paid", time: "1 jam lalu" },
];
...
export const ADMIN_DESTINATIONS = [
  ...
  },
  {
    ...
    ticket_categories: [
      { id: "cat-1", name: "WNI Weekdays", price: 25000, insurance: 2500, retribusi: 2500, is_active: true },
      { id: "cat-2", name: "WNI Weekend", price: 35000, insurance: 2500, retribusi: 2500, is_active: true },
...
export const PAYOUT_HISTORY = [
  { id: "po-001", period: "21 - 27 Jul 2026", gross: 198500000, platform_fee: 22350000, net_payout: 176150000, status: "settled", settled_at: "2026-07-28T10:00:00Z", bank: "Bank Mandiri - ****4821" },
  { id: "po-002", period: "14 - 20 Jul 2026", gross: 175200000, platform_fee: 19800000, net_payout: 155400000, status: "settled", settled_at: "2026-07-21T10:00:00Z", bank: "Bank Mandiri - ****4821" },
  { id: "po-003", period: "7 - 13 Jul 2026", gross: 162800000, platform_fee: 18400000, net_payout: 144400000, status: "settled", settled_at: "2026-07-14T10:00:00Z", bank: "Bank Mandiri - ****4821" },
  { id: "po-004", period: "28 Jul - 3 Ags 2026", gross: 62500000, platform_fee: 7000000, net_payout: 55500000, status: "pending", settled_at: null, bank: "Bank Mandiri - ****4821" },
];
...
export const QUOTA_CALENDAR = (() => {
  ...
  for (let i = 0; i < 14; i++) {
    ...
    data.push({
      ...
      is_closed: isClosed,
      close_reason: isClosed ? "Pemeliharaan Jalur Konservasi" : null,
    });
  }
  return data;
})();
