        ...
        <section className="relative isolate overflow-hidden bg-[var(--forest-deep)] text-white">
          ...
          <div className="mx-auto grid min-h-[calc(100vh-68px)] max-w-[1240px] gap-10 px-4 py-12 sm:px-6 sm:py-16 lg:grid-cols-[minmax(0,_1fr)_22rem] lg:items-end lg:gap-14 lg:px-8 lg:py-20">
            ...
            <aside className="rounded-2xl bg-[rgba(255,254,250,.96)] p-5 text-[var(--ink)] shadow-[0_20px_46px_rgba(0,0,0,.24)] backdrop-blur-md sm:p-6 lg:mb-3">
              ...
              <dl className="mt-5 grid grid-cols-2 gap-3"><div className="rounded-xl border border-[var(--border)] bg-[var(--canvas)] p-3"><dt className="text-[10px] font-extrabold uppercase tracking-wide text-[var(--ink-muted)]">Sisa kunjungan</dt><dd className="mt-1 text-xl font-extrabold tracking-[-.04em] text-[var(--forest-deep)]">58 orang</dd></div><div className="rounded-xl border border-[var(--border)] bg-[var(--canvas)] p-3"><dt className="text-[10px] font-extrabold uppercase tracking-wide text-[var(--ink-muted)]">Gate utama</dt><dd className="mt-1 text-sm font-extrabold text-[var(--forest)]">Siap menerima</dd></div></dl>
