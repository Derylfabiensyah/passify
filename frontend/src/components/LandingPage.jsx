      ...
      <main>
        <section className="relative isolate overflow-hidden bg-[var(--forest-deep)] text-white">
          ...
          <div className="mx-auto grid min-h-[calc(100vh-68px)] max-w-[1240px] gap-10 px-4 py-12 sm:px-6 sm:py-16 lg:grid-cols-[minmax(0,_1fr)_22rem] lg:items-end lg:gap-14 lg:px-8 lg:py-20">
            ...
            <aside className="rounded-[1.5rem] bg-[rgba(255,254,250,.96)] p-5 text-[var(--ink)] shadow-[0_20px_46px_rgba(0,0,0,.24)] backdrop-blur-md sm:p-6 lg:mb-3">
              ...
              <dl className="mt-5 grid grid-cols-2 gap-3"><div className="rounded-xl bg-[var(--canvas)] p-3"><dt className="text-[10px] font-extrabold uppercase tracking-wide text-[var(--ink-muted)]">Sisa kunjungan</dt><dd className="mt-1 text-xl font-bold tracking-[-.04em] text-[var(--forest-deep)]">58 orang</dd></div><div className="rounded-xl bg-[var(--canvas)] p-3"><dt className="text-[10px] font-extrabold uppercase tracking-wide text-[var(--ink-muted)]">Gate utara</dt><dd className="mt-1 text-sm font-bold text-[var(--forest)]">Siap menerima</dd></div></dl>
        ...
        <section id="masalah" className="scroll-mt-24 border-b border-[var(--border)] bg-[var(--sand)]">
          <div className="mx-auto max-w-[1240px] px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
            ...
            <div className="mt-10 grid gap-4 md:grid-cols-3 lg:gap-5">
              ...
              ].map(({ index, icon: Icon, title, text }) => <article key={index} className="rounded-[var(--radius-lg)] bg-[var(--canvas)] p-6 shadow-[0_18px_42px_rgba(16,45,32,.16)] sm:p-7"><div className="flex items-center justify-between"><span className="text-[11px] font-extrabold tracking-[.12em] text-[var(--bark)]">{index}</span><Icon className="h-5 w-5 text-[var(--forest-soft)]" strokeWidth={1.5} /></div><h3 className="mt-9 text-2xl font-bold leading-tight">{title}</h3><p className="mt-3 text-sm leading-6 text-[var(--ink-soft)]">{text}</p></article>)}
            </div>
          </div>
        </section>
